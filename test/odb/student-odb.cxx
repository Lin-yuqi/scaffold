...
namespace odb
{
        ...
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer = &i._birth_value;
    b[n].is_null = &i._birth_null;
    n++;
  }
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i._birth_value, is_null, v);
      i._birth_null = is_null;
    }
  ...
  bool access::view_traits_impl< ::Groupcount, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
    ODB_POTENTIALLY_UNUSED (i);
  ...
  void access::view_traits_impl< ::Groupcount, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i)
  {
    using namespace mysql;
    ...
    b[n].buffer_type = MYSQL_TYPE_LONGLONG;
    b[n].is_unsigned = 1;
    b[n].buffer = &i.class_sn_value;
    b[n].is_null = &i.class_sn_null;
    n++;
    ...
    b[n].buffer_type = MYSQL_TYPE_LONGLONG;
    b[n].is_unsigned = 1;
    b[n].buffer = &i.total_stu_value;
    b[n].is_null = &i.total_stu_null;
    n++;

    // avg_score
    //
    b[n].buffer_type = MYSQL_TYPE_DOUBLE;
    b[n].buffer = &i.avg_score_value;
    b[n].is_null = &i.avg_score_null;
    n++;
  }
  ...
  access::view_traits_impl< ::Groupcount, id_mysql >::query_base_type
  access::view_traits_impl< ::Groupcount, id_mysql >::
  query_statement (const query_base_type& q)
  {
    query_base_type r (
      ...
      "`tb_student`.`classes_id`, "
      "count(`tb_student`.`sn`), "
      "avg(`tb_student`.`score`) ");

    r += "FROM `tb_student`";

    query_base_type c (
      // From student.h:58:17
      (q.empty () ? query_base_type::true_expr : q) + " GROUP BY " + query_columns::classes_id);
  ...
  result< access::view_traits_impl< ::Groupcount, id_mysql >::view_type >
  access::view_traits_impl< ::Groupcount, id_mysql >::
  query (database& db, const query_base_type& q)
  {
    using namespace mysql;
