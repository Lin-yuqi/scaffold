...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_cal_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::cal::AddReq, a_),
  PROTOBUF_FIELD_OFFSET(::cal::AddReq, b_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::cal::AddRsp, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::cal::AddRsp, sum_),
};
...
const char descriptor_table_protodef_cal_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\tcal.proto\022\003cal\"\036\n\006AddReq\022\t\n\001a\030\001 \001(\005\022\t\n"
  "\001b\030\002 \001(\005\"\025\n\006AddRsp\022\013\n\003sum\030\001 \001(\0052-\n\nCalse"
  "rvice\022\037\n\003Add\022\013.cal.AddReq\032\013.cal.AddRspB\003"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cal_2eproto = {
  false, false, descriptor_table_protodef_cal_2eproto, "cal.proto", 131,
